...
const constants = {
  ...
  SAMPLE_EFFECT: {
    ...
    subheading: 'The QR code displayed is for display only. Finalized version will match your selected song.'
  }
};
              ...
              <CustomCol lg={6} xl={5}>
                <div className='m-5'>
                  ...
                  <InputGroup>
                    <InputGroup.Prepend>
                      <InputGroup.Text
                        style={{backgroundColor: '#007bff', color: 'white', borderRadius: '15px 0px 0px 0px'}}
                  ...
                  <InputGroup>
                    <InputGroup.Prepend>
                      <InputGroup.Text
                        style={{backgroundColor: '#007bff', color: 'white', borderRadius: '0px 0px 0px 15px'}}
                      ><BsFillPersonFill/></InputGroup.Text>
                    </InputGroup.Prepend>
                    <FormControl 
                      id="inlineFormInputGroup"
                  ...
                  options={[
                    {
                      ...
                      color: state.size ===  constants.CHOOSE_SIZE.option1 ? 'primary' : state.size ===  constants.CHOOSE_SIZE.option2 ? 'light' : 'secondary',
                      onClick: () => dispatch(updateSize(constants.CHOOSE_SIZE.option1))
                    },
                    {
                      text: constants.CHOOSE_SIZE.option2,
                      color: state.size ===  constants.CHOOSE_SIZE.option1 ? 'light' : state.size ===  constants.CHOOSE_SIZE.option2 ? 'primary' : 'secondary',
                      onClick: () => dispatch(updateSize(constants.CHOOSE_SIZE.option2))
                    }
                  ]}
                />
              </CustomCol>
                  ...
                  options={[
                    {
                      ...
                      color: state.frame ===  constants.ADD_FRAME.option1 ? 'primary' : state.frame ===  constants.ADD_FRAME.option2 ? 'light' : 'secondary',
                      onClick: () => dispatch(updateFrame(constants.ADD_FRAME.option1))
                    },
                    {
                      text: constants.ADD_FRAME.option2,
                      color: state.frame ===  constants.ADD_FRAME.option1 ? 'light' : state.frame ===  constants.ADD_FRAME.option2 ? 'primary' : 'secondary',
                      onClick: () => dispatch(updateFrame(constants.ADD_FRAME.option2))
                    }
                  ]}
                />
              </CustomCol>
                  ...
                  options={[
                    {
                      ...
                      color: state.shippingCharge ===  constants.SHIPPING.option1 ? 'primary' : state.shippingCharge ===  constants.SHIPPING.option2 ? 'light' : 'secondary',
                      onClick: () => dispatch(updateShippingCharge(constants.SHIPPING.option1))
                    },
                    {
                      text: constants.SHIPPING.option2,
                      color: state.shippingCharge ===  constants.SHIPPING.option1 ? 'light' : state.shippingCharge ===  constants.SHIPPING.option2 ? 'primary' : 'secondary',
                      onClick: () => dispatch(updateShippingCharge(constants.SHIPPING.option2))
                    }
                  ]}
                />
              </CustomCol>
